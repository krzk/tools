...
SELECT buildbot.buildrequests.*, from_unixtime(buildbot.buildrequests.submitted_at), buildbot.buildset_sourcestamps.buildsetid, buildbot.sourcestamps.id, buildbot.sourcestamps.project FROM buildbot.buildrequests
...
WHERE buildbot.buildrequests.complete = 0
	AND buildbot.sourcestamps.project = "krzk";
# And remove them:
