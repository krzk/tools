...
config_qcom_common() {
	...
	config_item_off ARCH_ARTPEC ARCH_EXYNOS ARCH_TESLA_FSD
	config_item_off ARCH_ACTIONS ARCH_AIROHA ARCH_SUNXI ARCH_ALPINE ARCH_APPLE ARCH_ARTPEC ARCH_AXIADO ARCH_BCM
	#ARCH_BCM2835 ARCH_BCM_IPROC ARCH_BCMBCA ARCH_BRCMSTB
	config_item_off ARCH_BERLIN ARCH_BLAIZE ARCH_BST ARCH_CIX ARCH_EXYNOS ARCH_SPARX5 ARCH_K3 ARCH_LG1K ARCH_HISI ARCH_KEEMBAY
	...
	config_item_off ARCH_SEATTLE ARCH_INTEL_SOCFPGA ARCH_SOPHGO ARCH_STM32 ARCH_SYNQUACER ARCH_TEGRA ARCH_TESLA_FSD
...
config_qcom() {
	...
	config_item_on PHY_QCOM_QUSB2 PHY_QCOM_USB_HSIC PHY_QCOM_USB_HS_28NM PHY_QCOM_USB_SS PHY_QCOM_EDP QCOM_PMIC_EUSB2_REPEATER
	# Same PHY, but renamed:
	config_item_on PHY_SNPS_EUSB2 PHY_QCOM_SNPS_EUSB2
	# More USB
	config_item_on TYPEC_UCSI UCSI_PMIC_GLINK TYPEC_QCOM_PMIC TYPEC_MUX_FSA4480 TYPEC_MUX_NB7VPQ904M
	# core drivers
	config_item_on INTERCONNECT_QCOM_SM8350 INTERCONNECT_QCOM_SM8450 INTERCONNECT_QCOM_SM8550 INTERCONNECT_QCOM_SM8750
	# TCSRCC got as module on SM8750 but is needed for UFS
	config_item_on SM_TCSRCC_8750
	# WiFi common
...
config_t14s() {
	...
	config_item_module SND_SOC_WCD937X_SDW SND_SOC_WCD939X_SDW TYPEC_MUX_WCD939X_USBSS
	...
	# libcamera softisp
	config_item_on UDMABUF DMABUF_HEAPS DMABUF_HEAPS_SYSTEM DMABUF_HEAPS_CMA
	# T14s and other laptops camera
	config_item_module VIDEO_OV08X40 VIDEO_OV02C10 VIDEO_OV02E10

	# For Ubuntu/snap
	config_item_module SQUASHFS
	config_item_on SQUASHFS_FILE_DIRECT SQUASHFS_COMPILE_DECOMP_MULTI SQUASHFS_MOUNT_DECOMP_THREADS SQUASHFS_XATTR SQUASHFS_LZ4 SQUASHFS_LZO SQUASHFS_XZ
